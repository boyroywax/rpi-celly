...
/*************	本地常量声明	**************/
static unsigned char *SMS_Num="\"+8613800755500\"";//短信中心号 关于中心号的介绍可以看串口调试笔记的第二部分
static unsigned char *phone="\"18565708640\"";     //短信接收方手机号
static unsigned char *content="sending message test";//发送短信内容
